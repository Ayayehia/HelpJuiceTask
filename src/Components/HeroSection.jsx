...
const HeroSection = () => {
  ...
  return (
    <article className="text-center flex flex-col items-center mt-20 px-6">
      ...
      <button className="flex gap-2 bg-black py-2 px-6 text-white rounded-lg font-mulish">
        Install Wizardshot
        <img src={arrow} />
      </button>
      <div className=" bg-gradient-to-b from-purple-500 to-pink-500 p-2 rounded-lg mt-12">
        <video
